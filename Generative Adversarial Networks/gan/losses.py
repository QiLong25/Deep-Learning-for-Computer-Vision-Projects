...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss_real = mse_loss(scores_real, torch.ones_like(scores_real))
    loss_fake = mse_loss(scores_fake, torch.zeros_like(scores_fake))
...
def ls_generator_loss(scores_fake):
    ...
    mse_loss = torch.nn.MSELoss()
    loss_fake = mse_loss(scores_fake, torch.ones_like(scores_fake))
    loss = loss_fake / 2
